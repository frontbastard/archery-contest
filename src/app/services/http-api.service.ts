...
export class HttpApiService {
  ...
  public get<T>(url: string, data?: Object, cancellecionSubject?: Observable<void>): Observable<T> {
  ...
  public post<T>(url: string, data?: Object, cancellecionSubject?: Observable<void>): Observable<T> {
    const requestUrl = this.combineCompleteUrl(url);
    let request = this.httpClient.post<T>(requestUrl, data);
    request = this.tryApplyCancellacionSubject(request, cancellecionSubject);
    return request;
  }
  public put<T>(url: string, data?: Object, cancellecionSubject?: Observable<void>): Observable<T> {
    const requestUrl = this.combineCompleteUrl(url);
    let request = this.httpClient.put<T>(requestUrl, data);
    request = this.tryApplyCancellacionSubject(request, cancellecionSubject);
    return request;
  }
  public delete<T>(url: string, data?: Object, cancellecionSubject?: Observable<void>): Observable<T> {
    const requestUrl = this.combineCompleteUrl(url, data);
  ...
  private tryApplyCancellacionSubject<T>(request: Observable<T>, cancellecionSubject?: Observable<void>): Observable<T> {
